...
<body>
            ...
            <div class="layui-form" lay-filter="">
              <div class="layui-card-body">
                <div class="layui-upload">
                  <button type="button" class="layui-btn" id="task-management">新建赞助</button>
  ...
  <div class="layui-row" id="popCreateTask" style="display:none;">
    ...
    <input type="hidden" name="app_img_url" class="image" >
     ...
     <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="text" name="icon_url" required lay-verify="required" autocomplete="off" placeholder="" class="layui-input">
        </div>
      </div>
      ...
      <div class="layui-form-item">
        <label class="layui-form-label">第一副标题</label>
        <div class="layui-input-block">
          <input type="text" name="first_line" required lay-verify="required" autocomplete="off" placeholder="" class="layui-input">
        </div>
      </div>
      <div class="layui-form-item">
        <label class="layui-form-label">第二副标题</label>
        <div class="layui-input-block">
          <input type="text" name="second_line" required lay-verify="required" autocomplete="off" placeholder="" class="layui-input">
        </div>
      </div>
      <div class="layui-form-item">
        <label class="layui-form-label">按钮名称</label>
        <div class="layui-input-block">
          <input type="text" name="button_text" required lay-verify="required" autocomplete="off" placeholder="" class="layui-input">
        </div>
      </div>
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-block">
          <input type="text" name="link_url" required lay-verify="required" autocomplete="off" placeholder="" class="layui-input">
        </div>
      </div>
      <div class="layui-form-item">
        <label class="layui-form-label">排序</label>
        <div class="layui-input-block">
          <input type="number" name="sort" required lay-verify="required" autocomplete="off" placeholder="" class="layui-input">
        </div>
      </div>
      <div class="layui-form-item">
      ...
      <div class="layui-form-item ">
        <div class="layui-input-block">
          <div class="layui-footer" style="left: 0;">
            <button class="layui-btn" lay-submit="" lay-filter="createTask">新建赞助</button>
    ...
    <input type="hidden" name="img_url" class="image" >
     ...
     <div class="layui-form-item">
      ...
      <div class="layui-form-item ">
        <div class="layui-input-block">
          <div class="layui-footer" style="left: 0;">
            <button class="layui-btn" lay-submit="" lay-filter="editChart">修改赞助</button>
<!--             <button type="reset" class="layui-btn layui-btn-primary">重置</button> -->
          </div>
        </div>
      </div>
      ...
      var uploadInst = upload.render({
        ...
        before: function(obj) {      
          ...
          if (res.status == 200) { 
            ...
            $(" input[ name='app_img_url' ] ").val(img_url);
        ...
        form.on('submit(editChart)', function(massage) {
          ...
          $.ajax({
            ...
            data: {
              id: data.id,
              sort:massage.sort,
              app_img_url:massage.app_img_url,
              icon_url:massage.icon_url,
              first_line:massage.first_line,
              second_line:massage.second_line,
              button_text:massage.button_text,
              link_url:massage.link_url,
              title:massage.title,
              state:massage.state
            },
