...
/*     ,url: '/demo/table/user/' */
    ,cols: [[
      ...
      ,{field:'cz', title: '充值金额', width:120}
      ,{field:'jl', title: '汇款方式', width:120}
      ,{field:'name', title: '汇款卡号', width:260}
      ,{field:'phone', title: '收款卡号',  width:260}
      ,{field:'zctime', title: '汇款时间',sort: true, width:160}
