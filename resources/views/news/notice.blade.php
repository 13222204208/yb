		...
		<form class="layui-form" action="" style="width: 60%;">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="notice_title" value="" class="layui-input" style="width: 350px;display: inline-block;">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<textarea class="layui-input" name="notice_content" style="width: 350px;height:100px;display: inline-block;"></textarea>
				</div>
			</div>
